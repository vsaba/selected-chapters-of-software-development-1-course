...
public class ArrayIndexedCollection<E> implements List<E>{
	 ...
	 *
	 */
	private static class ElementsGetterFromArrayCollection<E> implements ElementsGetter<E>{
		 ...
		 */
		public ElementsGetterFromArrayCollection(ArrayIndexedCollection<E> col) {
	...
	public ArrayIndexedCollection(int initalCapacity) {
		...
		this.elements = (E[])new Object[initalCapacity];
	 ...
	 */
	@SuppressWarnings("unchecked")
	public ArrayIndexedCollection(Collection<? extends E> collection, int initalCapacity) {
	...
	public void add(E value) {
		...
		if(size == elements.length) {
			...
			elements = null;
			elements = (E[]) new Object[tmpElements.length * 2];
